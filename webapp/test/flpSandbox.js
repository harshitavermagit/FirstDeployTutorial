		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#firstdeployfiori-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"firstdeployfiori-display": {
								"semanticObject": "firstdeployfiori",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=firstdeployfiori",
									"url": sap.ui.require.toUrl("firstdeployfiori")
								}
							}
						}
					}
